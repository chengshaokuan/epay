...
<script type="text/javascript">
    ...
    var setting = {
   		...
   		async: {
   			//开启异步加载模式
   			enable: true,
   			url: "${pageContext.request.contextPath}/permission/makeDetailTree.do?roleId=${role.id}"
   		}
    };
    ...
    $(function() {
        //集成jquery多tab页
        $('#tabs').tabs();
        $.fn.zTree.init($("#detail_tree"), setting);
    });
</script>
    ...
    <tr>
        <td>
            <table width="100%" border="0" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td>
                        <font style="font-size: 12px"><strong>角色详细信息</strong></font>
                    </td>
            ...
            <div id="tabs">
                <ul>
                    <li style="font-size: 12px;">
                        <a href="#tabs-1">角色信息</a>
                    </li>
                    <li style="font-size: 12px;">
                        <a href="#tabs-2">许可信息</a>
                    </li>
                </ul>
                <div id="tabs-1" style="background: #FFFFFF; font-size: 12px;">
			                    代码：${role.code }
			                    <br />
			                    <br />
			                    名称：${role.name }
